...
config.model.sigma_begin = 27.8 # !!! For CDL-D lambda/2
...
torch.save({'model_state': diffuser.state_dict(),
            ...
            'val_epoch': val_epoch}, 
   os.path.join(config.log_path, 'final_model_2users.pt'))
